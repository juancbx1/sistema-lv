...
export default function OPPontoPopup({ tipo, funcionario, onConfirmar, onCancelar }) {
    ...
    const s = {
        ...
        card: {
            ...
            maxWidth: '420px',
            overflow: 'hidden',
            boxShadow: '0 18px 48px rgba(36, 54, 75, 0.22)',
            animation: 'slideUp 0.2s ease',
        },
        accentBar: { height: '6px', background: cfg.cor },
        body: { padding: '18px' },
        empRow: { display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' },
        avatarImg: { width: 48, height: 48, borderRadius: '14px', objectFit: 'cover', flexShrink: 0 },
        avatarLetra: {
        ...
        nome: { margin: 0, fontWeight: 800, fontSize: '15px', color: 'var(--gs-texto-principal)' },
        cargo: { margin: '3px 0 0', fontSize: '12px', color: 'var(--gs-texto-secundario)' },
        divider: { height: '1px', background: '#e5edf5', margin: '0 0 14px' },
        acaoRow: {
            display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px',
            padding: '11px', border: `1px solid ${cfg.cor}33`, borderRadius: '12px',
        ...
        acaoLabel: { margin: 0, fontWeight: 800, fontSize: '14px', color: 'var(--gs-texto-principal)' },
        acaoDesc: { margin: 0, fontSize: '12px', color: 'var(--gs-texto-secundario)' },
        horarioRow: { display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '8px', marginBottom: '14px' },
        horarioBloco: {
            minWidth: 0, background: '#f7f9fc', border: '1px solid #e1eaf3',
