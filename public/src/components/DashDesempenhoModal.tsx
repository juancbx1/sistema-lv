...
import type { DashAcumulado, DashPeriodo } from '../utils/dashboard-types';
...
interface DashDesempenhoModalProps {
...
export default function DashDesempenhoModal({ dadosAcumulados, diasTrabalho, periodo, onClose }: DashDesempenhoModalProps) {
