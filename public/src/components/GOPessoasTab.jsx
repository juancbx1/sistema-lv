...
import GOPessoaCard from './GOPessoaCard.jsx';
    ...
    const filtradas = useMemo(() => {
        ...
        return pessoas.filter((pessoa) => {
            ...
            const vinculosDoEscopo = empresaDoContexto
                ? pessoa.vinculos.filter((item) => item.empresa_id === empresaDoContexto)
                : escopo === 'global'
                ? pessoa.vinculos
                : pessoa.vinculos.filter((item) => item.empresa_id === empresaAtivaId);
            return encontrou
