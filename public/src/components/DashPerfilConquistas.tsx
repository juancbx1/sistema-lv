...
interface DashPerfilConquistasProps {
    total?: number;
    desbloqueadas?: number;
    lista?: DashConquistaItem[] | null;
    loading?: boolean;
}

export default function DashPerfilConquistas({ total, desbloqueadas, lista, loading }: DashPerfilConquistasProps) {
    if (loading) {
        return (
