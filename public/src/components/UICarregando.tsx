// public/src/components/UICarregando.tsx
...
export type UICarregandoTamanho = 'sm' | 'md' | 'lg';

interface EmpresaAtivaContexto {
    id?: number | string;
...
function obterCorEmpresa(empresa: EmpresaAtivaContexto | null): string {
...
function obterContraste(cor: string): string {
...
export default function UICarregando({ variante = 'bloco', tamanho, texto }: UICarregandoProps) {
