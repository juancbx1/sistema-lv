// public/src/components/OPLancamentoExterno.jsx
...
export default function OPLancamentoExterno({ isOpen, onClose, onSucesso, onDesfazerSucesso }) {
    ...
    const handleDesfazer = async (item) => {
        ...
        try {
            ...
            carregarHistorico();
            if (onDesfazerSucesso) onDesfazerSucesso(); // atualiza fila sem fechar o modal
        } catch (err) {
    ...
    return (
        <div className="popup-container" style={{ display: 'flex' }}>
            ...
            <div className={`op-modal-atribuir-v2 ${tela === 'selecao' ? 'modo-lista' : 'modo-confirmacao'}`}>
