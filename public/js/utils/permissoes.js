...
export const permissoesDisponiveis = [
    ...
    criarPermissao('acesso-monitoramento-ops', {
        label: 'Acessar Central de Monitoramento de OPs',
        descricao: 'Exibe a Central de Monitoramento de OPs e permite analisar pendências de encerramento.',
        modulo: 'Produção',
        pagina: 'Ordens de Produção',
        aba: 'Monitoramento de OPs',
        tipo: 'escopo',
    }),
    criarPermissao('usar-agente-encerrador', {
        label: 'Usar Agente Encerrador de OPs (legado)',
        descricao: 'Permissão preservada somente para compatibilidade; não concede acesso à Central de Monitoramento de OPs.',
        modulo: 'Produção',
        pagina: 'Ordens de Produção',
        aba: 'Principal',
        tipo: 'acao',
    ...
    criarPermissao('usar-agente-central-ops', {
        label: 'Usar Agente de Encerramento Central (legado)',
        descricao: 'Permissão preservada somente para compatibilidade; não concede acesso à Central de Monitoramento de OPs.',
        modulo: 'Produção',
        pagina: 'Ordens de Produção',
        aba: 'Ordens de Produção',
