...
import { classificarVinculo } from './GOVinculoModal.jsx';
...
function DadosVinculo({ vinculo, encerrado = false }) {
...
export default function GOPessoaCard({ pessoa, empresaAtivaId, onEditarVinculo, onNovoVinculo, onEncerrarVinculo }) {
                        ...
                        {vinculosEncerrados.map((vinculo) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{ '--go-empresa-cor': vinculo.empresa_cor || '#94a3b8' }}
                                >
                                    <div className="go-vinculo-topo">
                                        <strong><i className="fas fa-building"></i> {vinculo.empresa_nome}</strong>
